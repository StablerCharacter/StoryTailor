...
appimage-resources:
	...
	cp ./assets/icon.png ./AppDir/io.github.stablercharacter.storytailor.png
...
flatpak-resources:
	tar caf ./build/StoryTailor-Linux-x64.tar.gz --directory=./build/linux/x64/release/ bundle/
	mkdir -p flatpak
	mkdir -p flatpak-repo

flatpak-bundle:
	flatpak build-bundle ./flatpak-repo StoryTailor-Linux-x64.flatpak io.github.stablercharacter.storytailor --runtime-repo=https://flathub.org/repo/flathub.flatpakrepo

flatpak-install: flatpak-resources
	${FLATPAK_BUILDER} --user --force-clean --repo=./flatpak-repo --install ./flatpak ./meta/io.github.stablercharacter.storytailor.yml
